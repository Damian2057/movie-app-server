...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ApiExceptions.TokenException.class, ApiExceptions.InvalidLoginDetails.class, ApiExceptions.ConnectionException.class, ApiExceptions.LogicException.class, ApiExceptions.ParameterException.class, ApiExceptions.InvalidBusinessArgumentException.class})
