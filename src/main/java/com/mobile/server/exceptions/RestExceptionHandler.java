...
import com.mobile.server.exceptions.types.InvalidBusinessArgumentException;
import com.mobile.server.exceptions.types.LogicException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({LogicException.class, LogicException.class, InvalidBusinessArgumentException.class})
